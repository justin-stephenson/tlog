...
class TlogPlayConfig:
    def __init__(self, reader=DEFAULT_TLOG_PLAY_READER, persist=DEFAULT_TLOG_PLAY_PERSIST,
                 lax=DEFAULT_TLOG_PLAY_LAX, file_reader_path=None, es_baseurl=None,
                 es_query=None):
        self.reader = reader
...
class TlogRecConfig:
    def __init__(self, latency=DEFAULT_TLOG_REC_LATENCY, payload=DEFAULT_TLOG_REC_PAYLOAD,
                 log_input=DEFAULT_TLOG_REC_LOG_INPUT, log_output=DEFAULT_TLOG_REC_LOG_OUTPUT,
                 log_window=DEFAULT_TLOG_REC_LOG_WINDOW, limit_rate=DEFAULT_TLOG_REC_LIMIT_RATE,
                 limit_burst=DEFAULT_TLOG_REC_LIMIT_BURST, limit_action=DEFAULT_TLOG_REC_LIMIT_ACTION,
...
class TlogRecSessionConfig(TlogRecConfig):
    def __init__(self, shell=DEFAULT_TLOG_REC_SESSION_SHELL, notice=DEFAULT_TLOG_REC_SESSION_NOTICE,
                 latency=DEFAULT_TLOG_REC_LATENCY, payload=DEFAULT_TLOG_REC_PAYLOAD,
                 log_input=DEFAULT_TLOG_REC_LOG_INPUT, log_output=DEFAULT_TLOG_REC_LOG_OUTPUT,
                 log_window=DEFAULT_TLOG_REC_LOG_WINDOW, limit_rate=DEFAULT_TLOG_REC_LIMIT_RATE,
                 limit_burst=DEFAULT_TLOG_REC_LIMIT_BURST, limit_action=DEFAULT_TLOG_REC_LIMIT_ACTION,
